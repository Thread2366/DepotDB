...
CREATE TABLE `brigades` (
  ...
  `FIOchief` varchar(40) DEFAULT NULL COMMENT 'ФИО бригадира',
  `Base` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`B_ID`),
  UNIQUE KEY `ID_UNIQUE` (`B_ID`),
  KEY `IsChief_idx` (`FIOchief`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Бригады';
...
INSERT INTO `brigades` VALUES (1,'Шеф1','Обр1'),(2,'Шеф2','Обр2');
